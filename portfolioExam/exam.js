...
menuNameElements.forEach( (menuName, index) => {
    ...
    menuName.addEventListener("mouseout", () => {
...
nameTag2.addEventListener("click", () => {
...
const skillsIconElements = document.querySelectorAll(".skillsIcon");
const skillNameElements = document.querySelectorAll(".skillName");

skillsIconElements.forEach( (skillsIcon, index) => {

    const skillName = skillNameElements[index];

    skillsIcon.addEventListener("mouseover", () => {

        skillsIcon.style.filter = "grayscale(0%)";
        skillName.style.visibility = "visible";
        skillName.style.opacity = "1";

    });

    skillsIcon.addEventListener("mouseout", () => {

        skillsIcon.style.filter = "grayscale(100%)";
...
nameTag3.addEventListener("click", () => {
...
const imgElements = document.querySelectorAll(".projectsImg");
const pElements = document.querySelectorAll(".projectName");
